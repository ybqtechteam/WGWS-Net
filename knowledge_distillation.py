...
# ! importante per la knoledge distillation
parser.add_argument('--eval_in_path_L', type=str,default= '/home/lorenzomignone/gitlab/vista/models/WGWS-Net/data/Realsnow85/001/input')
parser.add_argument('--eval_gt_path_L', type=str,default= '/home/lorenzomignone/gitlab/vista/models/WGWS-Net/data/Realsnow85/001/target')
...
parser.add_argument('--save_path', type=str,default= '/home/lorenzomignone/gitlab/vista/models/WGWS-Net/results')
...
def test(net,eval_loader,Dname = 'S',flag = [1,0,0],model_flag= args.flag,save_results_path=args.save_path):
    ...
    with torch.no_grad():
        ...
        for index, (data_in, label, name, H, W) in enumerate(tqdm(eval_loader), 0):# enumerate(eval_loader, 0):
            ...
            out_eval_np = cv2.resize(out_eval_np, (H.item(), W.item()), interpolation=cv2.INTER_CUBIC)
